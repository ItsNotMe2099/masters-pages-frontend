  ...
  return (
    <div className={`${styles.root}`}>
      ...
      <div className={styles.row}>
        ...
        <div className={styles.value}>{format(/*getEventPlannedAllowed(event) ?*/ new Date(event.start) /*: event.actualStart*/, 'HH:mm')}</div>
      </div>
      <div className={styles.row}>
        <div className={styles.label}>{t('endTime')}</div>
        <div className={styles.value}>{format(/*getEventPlannedAllowed(event) ?*/ new Date(event.end) /*: event.actualStart*/, 'HH:mm')}</div>
      </div>
