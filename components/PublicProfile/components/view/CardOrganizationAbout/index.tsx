...
const CardOrganizationAbout = (props: Props) => {
  ...
  return (
    <Card isHidden={!isEdit && !organization.about} className={styles.root} isLoading={showForm && formLoading} title={'Our mission'} toolbar={isEdit ? [<FormActionButton type={organization.about?.about ? 'edit' : 'create'} title={organization.about?.about ? t('edit') : t('add')} onClick={handleEditClick}/>] : []}>
