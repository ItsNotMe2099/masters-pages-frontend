    ...
    <div className={styles.root}>
      ...
      <div className={styles.details}>
        <div className={styles.detailsItem}>
          ...
          <div
            className={styles.detailsValue}>${message.taskNegotiation.priceType === 'fixed' ? `${getCurrencySymbol(task.currency)} ${message.taskNegotiation.budget}` : `${getCurrencySymbol(task.currency)} ${message.taskNegotiation.ratePerHour}/${}`}</div>
        </div>
        <div className={styles.detailsItem}>
