...
export default function TaskResponse({ response }: Props) {
  ...
  return ( <div className={styles.root}>
    ...
    <div className={styles.message}><img src={'/img/icons/chat_small.svg'} />{response.message}</div>
    ...
    {response.state !== 'declined' && <div className={styles.actions}>
      ...
      {response.state === 'accepted' && <div className={styles.action} onClick={handleAccept}>Messages</div>}
