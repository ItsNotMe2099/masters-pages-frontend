...
const ProjectEventInfoTab = ({event}: Props) => {
  ...
  return (
    <div className={styles.root} >
      <div className={styles.infoItem}>
        <div className={styles.label}>Project Number</div>
        <div className={styles.value}>#{event.projectId}</div>
      </div>
      <div className={styles.infoItem}>
      ...
      <div className={styles.infoItem}>
        ...
        <div className={styles.value}>{event.project?.title}</div>
      </div>
      <div className={styles.infoItem}>
...
export default ProjectEventInfoTab
