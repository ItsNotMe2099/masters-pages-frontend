...
import styles from 'components/for_pages/Project/ProjectModal/ProjectInfoForm/index.module.scss'
...
const selector = formValueSelector('ProjectInfoForm') // <-- same as form name
ProjectInfoForm = connect(state => {
