...
function LogoMobileSvg({color, className}: Props) {
  ...
  return (
    <svg className={className} width="26" height="31" viewBox="0 0 26 31" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M24.5852 13.9213V9.71484H1V30H16.1722L24.5852 21.587V18.1278H15.1335" stroke={ color ? getColor() : 'black'} stroke-width="1.97953"/>
      ...
      <path d="M7.10547 5.57893C9.68515 -0.804696 17.0802 -0.241434 19.316 5.57893" stroke={ color ? getColor() : 'black'} stroke-width="1.97953"/>
    </svg>
