...
function LogoSvg({color, className}: Props) {
  ...
  return (
    <svg className={className} width="37" height="45" viewBox="0 0 37 45" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M35.2912 13.7528V10.0398H1V44.1126H27.8651L35.2912 36.6865V17.4659H16.1701M10.6103 6.32671C13.8865 -1.09942 23.2784 -0.44417 26.1178 6.32671" stroke={ color ? getColor() : '#E4474E'} stroke-width="1.74732"/>
