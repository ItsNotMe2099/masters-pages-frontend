      ...
      <div className={styles.main}>
        <div className={styles.mainInfo}>
          ...
          <div className={styles.bottom}>
            ...
            <Button type='button' projectBtn='default' onClick={() => profile ? null : router.push('/registration/user')}>SAVE</Button>
            <Button type='button' projectBtn='default' onClick={() => profile ? null : router.push('/registration/user')}>SUBSCRIBE</Button>
          </div>
        </div>
      </div>
